...
public class Control : MonoBehaviour {
    ...
    Vector3 _dest = new Vector3(-28.97f, 0.172f, -14.376f);
    ...
    bool Valid(Vector3 direction) {
        ...
        return true;
        //return hit.collider.name == "pacdot" || (hit.collider == GetComponent<Collider>());
    }

    void MoveBasedOnPosition() {
        Vector3 p = Vector3.MoveTowards(transform.position, _dest, 0.025f);
